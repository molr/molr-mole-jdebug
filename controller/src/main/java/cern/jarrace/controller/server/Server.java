...
public interface Server {
     ...
     */
    Set<AgentContainer> listContainers();

    /**
     * Executes a {@link Service} from a specific {@link AgentContainer}
     *
     * @param agentContainer {@link AgentContainer} from where the service will be executed
     ...
     */
    String runService(AgentContainer agentContainer, Service service, List<String> entryPoints) throws Exception;
